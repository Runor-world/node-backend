...
router.route('/profile-photo').patch(authenticateUser, updateProfilePhoto)
router.route('/profile-backgroundphoto').patch(authenticateUser, updateProfileBackgroundPhoto)
